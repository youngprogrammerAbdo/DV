...
import CreatDjVu.Textpdf;
import static  OCR.OCROnTiFImage.show;
...
import static com.lizardtech.djvubean.DjVuBean.SINGLE_PAGE_LAYOUT;
...
public class RibbonMenuCreation extends JRibbonFrame implements RibbonGetIcon {
    ...
    // flag for markup 
    public static int markup;
    public static int popup_note ;
...
//this method to get icon from resource and set it into commponents
            ...
            public void actionPerformed(ActionEvent e) {
                SwingUtilities.invokeLater(new Runnable() {
                    ...
                    public void run() {
                        ...
                        // for english
                      String text=  ((JTextField) AreaSearch).getText();
                      char letter=text.charAt(0);
                      if ((letter >= 'a' && letter <= 'z') || (letter >= 'A' && letter <= 'Z')) {
                        //english letter
                          searchDocument(true,((JTextField) AreaSearch).getText());
                         }
                      else
                      {
                          // for arabic  
                        String arabic =re(((JTextField) AreaSearch).getText());
                     //   JOptionPane.showMessageDialog(null, arabic);
                        searchDocument(true,arabic);
                      }
    ...
    public JFlowRibbonBand getTextmarkupBand(final DjvuStart djvu) {
        ...
        HighLight.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                URL iconURL = getClass().getResource("/images/yellow_highlight.png");
                ImageIcon icon = new ImageIcon(iconURL);
                Cursor c = toolkit.createCustomCursor(icon.getImage(), new Point(djvubean.getX(), djvubean.getY()), "img");
    ...
    return output;
     ...
     public void write(String txt){
             File myFile =new File("D:\\all\\Data.txt");
    ...
    String v1=txt;
     ...
     public String read() throws FileNotFoundException, IOException{
         FileReader fr=new FileReader("D:\\all\\Data.txt");
