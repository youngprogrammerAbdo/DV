  ...
  implements MouseMotionListener
{
  ...
  // successfull.
  public  boolean switchColor(Graphics g,int color)
  {
  ...
  //
  public  void drawLine(Graphics g,int x0,int y0,int x1,int y1,int weight,boolean arrow)
  {
    double dx=x1-x0;
    double dy=y1-y0;
