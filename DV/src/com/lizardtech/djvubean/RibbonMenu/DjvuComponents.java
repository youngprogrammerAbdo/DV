...
//       // styleStrip.add(Button.styleStrikeThroughButton);
    ...
    public JRibbonBand getTypewriterBand() {
        ...
        Button.TWriter.addActionListener(new ActionListener() {

            @Override
            public void actionPerformed(ActionEvent e) {
               
                djvubean.setMode(DjVuBean.Mark_MODE);
                typewriter=1;
    ...
    public JRibbonBand getDrawingBand() {
        ...
        Button.Rect.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
              ...
              drawing=1;
            djvubean.setMode(DjVuBean.Mark_MODE); 
              djvubean.setCursor(Cursor.getPredefinedCursor(Cursor.MOVE_CURSOR));
        ...
        Button.Oval.addActionListener(new ActionListener() {
        ...
        Button.Polygon = new JCommandButton("", getResizableIconFromResource("/images/RoundRectangle.PNG"));
        Button.Polygon.setEnabled(false);
        ...
        Button.Polygon.addActionListener(new ActionListener() {
        ...
        Button.Cloud = new JCommandButton("", getResizableIconFromResource("/images/red.PNG"));
        Button.Cloud.setDisplayState(CommandButtonDisplayState.SMALL);
        Button.Cloud.setEnabled(false);
        Button.Cloud.addActionListener(new ActionListener() {
        ...
        Button.arrow.setEnabled(false);
        Button.arrow.addActionListener(new ActionListener() {
        ...
        Button.Line.addActionListener(new ActionListener() {
...
//        editG2D.drawLine(SelectMode.x, SelectMode.y,SelectMode.w, SelectMode.z);
        ...
        Button.Eraser.addActionListener(new ActionListener() {
        ...
        Button.AreaHighLight.addActionListener(new ActionListener() {
