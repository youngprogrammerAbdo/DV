...
import com.lizardtech.djvubean.outline.*;
...
public class Applet
     ...
     */
    public static final int FIT_PAGE = -4;
  ...
  //~ Methods ----------------------------------------------------------------
    ...
    public Container getCenterPane()
        ...
        if (retval == null) {
            synchronized (this) {
                ...
                if (retval == null) {
                    retval = new Panel();
                    retval.setBackground(new Color(122, 102, 82));
    ...
    public Component getScrollPane()
        ...
        if (retval == null) {
            ...
            if (page instanceof DjVuViewport) {
                ...
                retval.setBackground(new Color(152, 12, 22));
    ...
    public void init() {
        ...
        try {
            ...
            String[][] pinfo = getParameterInfo();
            properties.setProperty("navpane", "Outline");
            for (int i = 0; i < pinfo.length;) {
                final String name = pinfo[i++][0];
                final String value = getParameter(name);
...
//        
            ...
            DjvuStart.beanMap.put(url2, getDjVuBean());
